...
public class login extends JFrame {
	...
	public login() {
		...
		jf.getContentPane().setBackground(new Color(128, 255, 128));
		// tạo login
		...
		jblogin.setIcon(new ImageIcon("D:\\Textgithub\\hinhom6\\anh\\z5437697937958_d2bccedfacc45a5b439290acad0ebe9e.jpg"));
		...
		jbreturn.setIcon(new ImageIcon("D:\\Textgithub\\hinhom6\\anh\\z5437697879858_5035fd6824da64071974a00cb2eb0d92.jpg"));
